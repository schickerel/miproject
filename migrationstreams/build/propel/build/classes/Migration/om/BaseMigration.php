 ...
 */
abstract class BaseMigration extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Migration\\MigrationPeer';
     ...
     * @return Migration The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = MigrationPeer::ID;
        }
    ...
    public function setCity($v)
    {
        ...
        if ($this->city !== $v) {
            $this->city = $v;
            $this->modifiedColumns[] = MigrationPeer::CITY;
        }
    ...
    public function setCountryId($v)
    {
        ...
        if ($this->country_id !== $v) {
            $this->country_id = $v;
            $this->modifiedColumns[] = MigrationPeer::COUNTRY_ID;
        }
    ...
    public function setMonth($v)
    {
        ...
        if ($this->month !== $v) {
            $this->month = $v;
            $this->modifiedColumns[] = MigrationPeer::MONTH;
        }
    ...
    public function setYear($v)
    {
        ...
        if ($this->year !== $v) {
            $this->year = $v;
            $this->modifiedColumns[] = MigrationPeer::YEAR;
        }
    ...
    public function setPersonId($v)
    {
        ...
        if ($this->person_id !== $v) {
            $this->person_id = $v;
            $this->modifiedColumns[] = MigrationPeer::PERSON_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->person_id = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
            $this->resetModified();
            ...
            return $startcol + 6; // 6 = MigrationPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Migration object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = MigrationPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = MigrationQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MigrationPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(MigrationPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(MigrationPeer::CITY)) {
            $modifiedColumns[':p' . $index++]  = '`city`';
        }
        if ($this->isColumnModified(MigrationPeer::COUNTRY_ID)) {
            $modifiedColumns[':p' . $index++]  = '`country_id`';
        }
        if ($this->isColumnModified(MigrationPeer::MONTH)) {
            $modifiedColumns[':p' . $index++]  = '`month`';
        }
        if ($this->isColumnModified(MigrationPeer::YEAR)) {
            $modifiedColumns[':p' . $index++]  = '`year`';
        }
        if ($this->isColumnModified(MigrationPeer::PERSON_ID)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = MigrationPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = MigrationPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Migration'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Migration'][$this->getPrimaryKey()] = true;
        $keys = MigrationPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getCity(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[5], $arr)) $this->setPersonId($arr[$keys[5]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MigrationPeer::ID)) $criteria->add(MigrationPeer::ID, $this->id);
        if ($this->isColumnModified(MigrationPeer::CITY)) $criteria->add(MigrationPeer::CITY, $this->city);
        if ($this->isColumnModified(MigrationPeer::COUNTRY_ID)) $criteria->add(MigrationPeer::COUNTRY_ID, $this->country_id);
        if ($this->isColumnModified(MigrationPeer::MONTH)) $criteria->add(MigrationPeer::MONTH, $this->month);
        if ($this->isColumnModified(MigrationPeer::YEAR)) $criteria->add(MigrationPeer::YEAR, $this->year);
        if ($this->isColumnModified(MigrationPeer::PERSON_ID)) $criteria->add(MigrationPeer::PERSON_ID, $this->person_id);
    ...
    {
        $criteria = new Criteria(MigrationPeer::DATABASE_NAME);
        $criteria->add(MigrationPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Migration (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Migration Clone of current object.
     * @throws PropelException
     */
    ...
    public function getCountry(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCountry === null && ($this->country_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCountry->addMigrations($this);
             */
        }
    ...
    public function getPerson(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPerson === null && ($this->person_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPerson->addMigrations($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(MigrationPeer::DEFAULT_STRING_FORMAT);
    }
