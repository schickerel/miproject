...
/**
 * Base class that represents a row from the 'professional_categories' table.
 *
 *
 *
 * @package    propel.generator.ProfessionalCategory.om
 */
abstract class BaseProfessionalCategory extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProfessionalCategory\\ProfessionalCategoryPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProfessionalCategoryPeer
     */
    ...
    /**
     * The value for the professional_category field.
     * @var        string
     */
    ...
    /**
     * Get the [professional_category] column value.
     *
     * @return string
     */
     ...
     * @return ProfessionalCategory The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = ProfessionalCategoryPeer::ID;
        }
    ...
    /**
     * Set the value of [professional_category] column.
     *
     * @param  string $v new value
     * @return ProfessionalCategory The current object (for fluent API support)
     */
    public function setProfessionalCategory($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->professional_category !== $v) {
            $this->professional_category = $v;
            $this->modifiedColumns[] = ProfessionalCategoryPeer::PROFESSIONAL_CATEGORY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->professional_category = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = ProfessionalCategoryPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProfessionalCategory object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProfessionalCategoryPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProfessionalCategoryQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ProfessionalCategoryPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProfessionalCategoryPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ProfessionalCategoryPeer::PROFESSIONAL_CATEGORY)) {
            $modifiedColumns[':p' . $index++]  = '`professional_category`';
        }

        $sql = sprintf(
            'INSERT INTO `professional_categories` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`professional_category`':
                        $stmt->bindValue($identifier, $this->professional_category, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProfessionalCategoryPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProfessionalCategoryPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getProfessionalCategory();
                break;
            default:
                return null;
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['ProfessionalCategory'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProfessionalCategory'][$this->getPrimaryKey()] = true;
        $keys = ProfessionalCategoryPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getProfessionalCategory(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setProfessionalCategory($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setProfessionalCategory($arr[$keys[1]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProfessionalCategoryPeer::ID)) $criteria->add(ProfessionalCategoryPeer::ID, $this->id);
        if ($this->isColumnModified(ProfessionalCategoryPeer::PROFESSIONAL_CATEGORY)) $criteria->add(ProfessionalCategoryPeer::PROFESSIONAL_CATEGORY, $this->professional_category);
    ...
    {
        $criteria = new Criteria(ProfessionalCategoryPeer::DATABASE_NAME);
        $criteria->add(ProfessionalCategoryPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProfessionalCategory (or compatible) type.
    ...
    {
        $copyObj->setProfessionalCategory($this->getProfessionalCategory());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProfessionalCategory Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProfessionalCategoryPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProfessionalCategoryPeer();
        }
     ...
     * If this ProfessionalCategory is new, it will return
        ...
        if (null === $this->collPersons || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collPersons) {
                ...
                $collPersons = PersonQuery::create(null, $criteria)
                    ->filterByProfessionalCategory($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setPersons(PropelCollection $persons, PropelPDO $con = null)
    {
        ...
        foreach ($personsToDelete as $personRemoved) {
            $personRemoved->setProfessionalCategory(null);
        }
    ...
    protected function doAddPerson($person)
    {
        ...
        $person->setProfessionalCategory($this);
    }
    ...
    public function removePerson($person)
    {
        if ($this->getPersons()->contains($person)) {
            ...
            $person->setProfessionalCategory(null);
        }
     ...
     * Otherwise if this ProfessionalCategory is new, it will return
     * an empty collection; or if this ProfessionalCategory has previously
     * been saved, it will retrieve related Persons from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in ProfessionalCategory.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Person[] List of Person objects
     */
    public function getPersonsJoinDenomination($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = PersonQuery::create(null, $criteria);
        $query->joinWith('Denomination', $join_behavior);
    ...
    {
        $this->id = null;
        $this->professional_category = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
    ...
    {
        return (string) $this->exportTo(ProfessionalCategoryPeer::DEFAULT_STRING_FORMAT);
    }
