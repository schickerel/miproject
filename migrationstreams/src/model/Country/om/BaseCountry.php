...
abstract class BaseCountry extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Country\\CountryPeer';
    ...
    public function setMigrations(PropelCollection $migrations, PropelPDO $con = null)
    {
        ...
        foreach ($migrationsToDelete as $migrationRemoved) {
            $migrationRemoved->setCountry(null);
        }
     ...
     * @return PropelObjectCollection|Migration[] List of Migration objects
     */
    public function getMigrationsJoinPerson($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = MigrationQuery::create(null, $criteria);
