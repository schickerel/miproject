...
use Country\map\CountryTableMap;
...
abstract class BaseCountryPeer
{
    ...
    const OM_CLASS = 'Country\\Country';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Country', 'Code', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'country', 'code', ),
        BasePeer::TYPE_COLNAME => array (CountryPeer::ID, CountryPeer::COUNTRY, CountryPeer::CODE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'COUNTRY', 'CODE', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'country', 'code', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Country' => 1, 'Code' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'country' => 1, 'code' => 2, ),
        BasePeer::TYPE_COLNAME => array (CountryPeer::ID => 0, CountryPeer::COUNTRY => 1, CountryPeer::CODE => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'COUNTRY' => 1, 'CODE' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'country' => 1, 'code' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCountryPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Country\map\CountryTableMap());
      }
    }
